...
MACRO_CONFIG_INT(InpMousesens, inp_mousesens, 200, 0, 100000, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Mouse sensitivity")
...
MACRO_CONFIG_INT(SvSwap, sv_swap, 1, 0, 1, CFGFLAG_SERVER, "Turns /swap on/off")
