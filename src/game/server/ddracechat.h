...
CHAT_COMMAND("rank", "?r[playername]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConRank, this, "Shows the rank of player with name r (your rank by default)")
...
CHAT_COMMAND("saytime", "?r[playername]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConSayTime, this, "Privately messages someone's current time in this current running race (your time by default)")
...
CHAT_COMMAND("points", "?r[playername]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConPoints, this, "Shows the global points of a player beginning with name r (your rank by default)")
...
CHAT_COMMAND("dummy", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummy, this, "Creates your own Dummy if it doesn\'t exist")
CHAT_COMMAND("dummy_del", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyDelete, this, "Removes your Dummy")
CHAT_COMMAND("dummy_change", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyChange, this, "Swap you with your dummy")
CHAT_COMMAND("dummy_swap", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyChange, this, "Swap you with your dummy")
CHAT_COMMAND("dummy_hammer", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyHammerFly, this, "Your Dummy looks at you and hitting with hammer")
CHAT_COMMAND("dummy_hammerfly", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyHammerFly, this, "Your Dummy looks at you and hitting with hammer")
CHAT_COMMAND("control_dummy", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyControl, this, "Go to spectators and control your dummy")
CHAT_COMMAND("dummy_copy_move", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyCopyMove, this, "Dummy copies all your movement.")
//the same but in another interpretation
CHAT_COMMAND("d", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummy, this, "Creates your own Dummy if it doesn\'t exist")
CHAT_COMMAND("dummy_delete", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyDelete, this, "Removes your Dummy")
CHAT_COMMAND("delete", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyDelete, this, "Removes your Dummy")
CHAT_COMMAND("dd", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyDelete, this, "Removes your Dummy")
CHAT_COMMAND("dc", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyChange, this, "Swap you with your dummy")
CHAT_COMMAND("ds", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyChange, this, "Swap you with your dummy")
CHAT_COMMAND("dh", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyHammerFly, this, "Your Dummy looks at you and hitting with hammer")
CHAT_COMMAND("dhf", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyHammerFly, this, "Your Dummy looks at you and hitting with hammer")
CHAT_COMMAND("cd", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyControl, this, "Go to spectators and control your dummy")
CHAT_COMMAND("dcm", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyCopyMove, this, "Dummy copies all your movement. Smth like multiclient.")
CHAT_COMMAND("dhook", "", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDummyHook, this, "Experimental Hook Fly")

//mkRace
CHAT_COMMAND("r", "?s[d]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConRescue, this, "/r-rescue, \'/r d\' for dummy rescue.")
CHAT_COMMAND("rescue", "?s[d]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConRescue, this, "/r-rescue, \'/r d\' for dummy rescue.")
CHAT_COMMAND("dr", "?s[d]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDisconnectRescue, this, "Rescue to location before disconnect, \'/dr d\' for dummy rescue.")
CHAT_COMMAND("disconnect_rescue", "?s[d]", CFGFLAG_CHAT|CFGFLAG_SERVER, ConDisconnectRescue, this, "Rescue to location before disconnect, \'/dr d\' for dummy rescue.")
