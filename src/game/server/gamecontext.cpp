...
void CGameContext::OnClientEnter(int ClientID)
{
	...
	if(((CServer *) Server())->m_aPrevStates[ClientID] < CServer::CClient::STATE_INGAME && !m_apPlayers[ClientID]->m_IsDummy) //iDDNet
	{
		char aBuf[512];
